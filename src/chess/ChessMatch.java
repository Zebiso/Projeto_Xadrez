...
public class ChessMatch {
    ...
    private Piece makeMove ( Position source, Position target){
        ...
        if (p instanceof King && target.getCollum()== source.getCollum()+2){
            Position sourcR= new Position(source.getRow(), source.getCollum()+3);
            Position targetR= new Position(source.getRow(), source.getCollum()+1);
            ChessPiece rook = (ChessPiece)board.removePiece(sourcR);
        ...
        if (p instanceof King && target.getCollum()== source.getCollum()-2){
            Position sourcR= new Position(source.getRow(), source.getCollum()-4);
            Position targetR= new Position(source.getRow(), source.getCollum()-1);
            ChessPiece rook = (ChessPiece)board.removePiece(sourcR);
            board.placePiece(rook, targetR);
            rook.increaseMoveCount();
